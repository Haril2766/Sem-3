...
SELECT CNAME,BNAME FROM DEPOSITE WHERE AMOUNT>4000 AND AMOUNT<8000
...
SELECT ACTNO , CNAME , AMOUNT FROM DEPOSITE WHERE BNAME IN ('AJNI','KAROLBAGH','M.G.RODE') AND ACTNO < 104